...
function Theme({ name, note, mode, font, current, choose, accent, fontStyle, setAccent, setFont }: { name: string; note: string; mode: string; font: string; defaultFont: string; current: string; choose: (mode: string) => void; accent: string; fontStyle: string; setAccent: (value: string) => void; setFont: (value: string) => void }) {
